...
public class Lamps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View add1 = findViewById(R.id.addLamp1);
        ...
        View add2 = findViewById(R.id.addLamp2);
        ...
        View add3 = findViewById(R.id.addLamp3);
        ...
        View add4 = findViewById(R.id.addLamp4);
        ...
        View add5 = findViewById(R.id.addLamp5);
        ...
        View add6 = findViewById(R.id.addLamp6);
        ...
        View add7 = findViewById(R.id.addLamp7);
        ...
        View add8 = findViewById(R.id.addLamp8);
        ...
        View add9 = findViewById(R.id.addLamp9);
        ...
        View add10 = findViewById(R.id.addLamp10);
